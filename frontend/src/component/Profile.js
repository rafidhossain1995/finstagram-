        ...
        <div className="profile-page">
            <div className="profile-image">
                ...
                <div className = "setting">
                    <h1 className="user-name">Rafid Hossain</h1>
                </div>
                    <div className="stats">
                        <ul>
                        <li><span class="count">0</span> posts</li>
					    <li><span class="count">0</span> followers</li>
					    <li><span class="count">0</span> following</li>
                        </ul>
                    </div>
                <div className="profile-description">
                    <p>Hi I'm Rafid, Let's Code </p>
                </div>

        </div>
            <div clasNames="gallery">
