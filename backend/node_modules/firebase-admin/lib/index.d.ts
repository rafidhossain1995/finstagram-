...
import * as _auth from 'firebase-admin/lib/auth';
import * as _database from 'firebase-admin/lib/database';
import * as _messaging from 'firebase-admin/lib/messaging';
import * as _instanceId from 'firebase-admin/lib/instance-id';
import * as _projectManagement from 'firebase-admin/lib/project-management';
import * as _securityRules from 'firebase-admin/lib/security-rules';
